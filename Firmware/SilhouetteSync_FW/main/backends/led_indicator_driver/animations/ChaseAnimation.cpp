    ...
    , direction(direction)
{
    esp_timer_create_args_t animation_timer_args = {
            .callback = &this->animation_timer_cb_trampoline, .arg = this, .name = "ChaseAnimation"};
...
void ChaseAnimation::build_pixel_buffer()
{
    ...
    //intensity_buffer = {led_intensity_max,(uint8_t)(led_intensity_max*0.75),(uint8_t)(led_intensity_max*0.5),(uint8_t)(led_intensity_max*0.25)};
