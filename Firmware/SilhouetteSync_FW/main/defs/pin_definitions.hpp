...
// Power Stuff
static constexpr gpio_num_t pin_charge_state = GPIO_NUM_1;  ///<LiPo charge IC status. Low when charging
static constexpr gpio_num_t pin_vbat_adc = GPIO_NUM_3;      ///<Scaled battery voltage by 0.545
static constexpr gpio_num_t pin_pwr_or_state = GPIO_NUM_10; ///<Power source indicator. Low when USB powered
