...
public class JointControlBench : MonoBehaviour
{
    ...
    [SerializeField] private AudioClip audioClipSetOneComplete;
    [SerializeField] private AudioClip audioClipSetTwoComplete;
    [SerializeField] private AudioClip audioClipSetThreeComplete;
    [SerializeField] private AudioClip audioClipSetFourComplete;
    [SerializeField] private AudioClip audioClipSetFiveComplete;
    [SerializeField] private AudioClip audioClipSetSixComplete;
    [SerializeField] private AudioClip audioClipSetSevenComplete;
    [SerializeField] private AudioClip audioClipSetEightComplete;
    [SerializeField] private AudioClip audioClipSetNineComplete;
    [SerializeField] private AudioClip audioClipSetTenComplete;
    [SerializeField] private AudioClip audioClipAllSetsComplete;
    ...
    */
    ...
    public RepButton repTarget;
    public SetButton setTarget;
    ...
    Quaternion leftSholderOffset  = new Quaternion(1, 1, 1, 1);
    Quaternion leftForearmOffset  = new Quaternion(1, 1, 1, 1);
    ...
    void Update()
    {
        ...
        */
        ...
        position1proccessedWithOffset = leftSholderOffset * position1proccessed;
        position2proccessedWithOffset = leftForearmOffset * position2proccessed;
        ...
        if (benchCycle) {
            ...
            if (benchStep1 && benchStep2 && benchStep3 && benchStep4 && benchStep5) {
                ...
                if(repCounter == repTarget.repTarget)
                {
                    repCounter = 0;
                    setCounter++;
                    if (setCounter == setTarget.setTarget){
                        audioSource.clip = audioClipAllSetsComplete;
                        audioSource.Play();
                    }
                    else if (setCounter == 1) {
                        audioSource.clip = audioClipSetOneComplete;
                        audioSource.Play();
                    }
                    else if (setCounter == 2) {
                        audioSource.clip = audioClipSetTwoComplete;
                        audioSource.Play();
                    }
                    else if (setCounter == 3) {
                        audioSource.clip = audioClipSetThreeComplete;
                        audioSource.Play();
                    }
                    else if (setCounter == 4) {
                        audioSource.clip = audioClipSetFourComplete;
                        audioSource.Play();
                    }
                    else if (setCounter == 5) {
                        audioSource.clip = audioClipSetFiveComplete;
                        audioSource.Play();
                    }
                    else if (setCounter == 6) {
                        audioSource.clip = audioClipSetSixComplete;
                        audioSource.Play();
                    }
                    else if (setCounter == 7) {
                        audioSource.clip = audioClipSetSevenComplete;
                        audioSource.Play();
                    }
                    else if (setCounter == 8) {
                        audioSource.clip = audioClipSetEightComplete;
                        audioSource.Play();
                    }
                    else if (setCounter == 9) {
                        audioSource.clip = audioClipSetNineComplete;
                        audioSource.Play();
                    }
                    else if (setCounter == 10) {
                        audioSource.clip = audioClipSetTenComplete;
                        audioSource.Play();
                    }
                }
                benchCycle = false;
        ...
        if (calbool.calibrationButton) 
        {
            ...
            leftSholderOffset = cal1Quat * Quaternion.Inverse(position1proccessed);
            leftForearmOffset = cal2Quat * Quaternion.Inverse(position2proccessed);
